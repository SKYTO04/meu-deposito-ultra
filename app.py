...
DB_PRODUTOS = "produtos_v41.csv"
DB_ESTOQUE = "estoque_v41.csv"
PILAR_ESTRUTURA = "pilares_v41.csv"
USERS_FILE = "usuarios_v41.csv"
LOG_FILE = "historico_v41.csv"
CASCOS_FILE = "cascos_v41.csv"
...
if st.session_state["authentication_status"]:
    ...
    # --- ABA: CADASTRO DE PRODUTOS (COM LISTA DE EXCLUSÃO) ---
    elif menu == "✨ Cadastro de Produtos":
        st.title("✨ Cadastro de Novos Itens")
        with st.form("cad_v41"):
            ...
            if st.form_submit_button("Cadastrar"):
                if nome and nome not in df_prod['Nome'].values:
                    ...
                    st.error("Produto já existe ou nome vazio.")
