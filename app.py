    ...
    # --- 👥 EQUIPE ---
        ...
        for i, r in df_usr.iterrows():
            with st.container():
                ...
                st.markdown(f'<div style="background-color: #1c2128; padding: 15px; border-radius: 15px; border: 1px solid #30363d; margin-bottom: 10px; display: flex; align-items: center;"><img src=
